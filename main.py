...
class Academy:
    ...
    @academy_name.setter
    def academy_name(self, academy_name):
        if len(academy_name) > 2:
            self.__academy_name = academy_name


class Student(Person, Academy):
    def __init__(self, name, age, academy_name):
        super().__init__(name, age)
        Person.__init__(self, name, age)
        Academy.__init__(self, academy_name)

    def show_info(self):
        super().show_info()
        print(f"Student Academy: {self.academy_name}")


class Employee(Person, Academy):
    def __init__(self, name, age, academy_name):
        super().__init__(name, age)
        Person.__init__(self, name, age)
        Academy.__init__(self, academy_name)
    ...
    def show_info(self):
        super().show_info()
        print(f"Employee Academy: {self.academy_name}")
class Teacher(Employee):
    def __init__(self, name, age, academy_name, subject_teacher=None):
        super().__init__(name, age, academy_name)
...
vasya = Student("Vasya", 18, "Home")
vasya.show_info()
print()
petya = Employee("Petya", 50, "Home")
petya.show_info()
print()
anton = Teacher("Anton", 40, "Home", "Mathematics")
anton.show_info()